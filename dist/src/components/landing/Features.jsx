...
const lucide_react_1 = require("lucide-react"); // Optional: use lucide icons
const features = [
    {
        icon: <lucide_react_1.Building2 className="w-6 h-6"/>,
...
function Features() {
    return (<section className="mt-20">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        {features.map((f, idx) => (<div key={idx} className="border border-[#dae6d1] bg-white rounded-xl p-5 flex flex-col gap-2">
