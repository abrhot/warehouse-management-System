...
export default function ReportsFilters({ onChange }: ReportsFiltersProps) {
  return (
    <div className="flex flex-col gap-3 px-4">
      <select 
        onChange={(e) => onChange('dateRange', e.target.value)}
        className="h-14 rounded-xl border border-[#dae7d0] bg-[#fafcf8] px-4 text-base text-[#141b0e]"
      >
