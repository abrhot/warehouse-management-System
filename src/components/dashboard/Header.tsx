...
const Header = () => {
  return (
    <header className="flex items-center justify-between border-b border-[#edf1ea] px-10 py-3">
      ...
      <div className="flex flex-1 justify-end gap-8">
        <nav className="flex gap-9 text-sm font-medium text-[#141810]">
          {['Dashboard', 'Stock In/Out', 'Product Management', 'Reports', 'User Management'].map((label) => (
        ...
        <div
          ...
          style={{
            backgroundImage:
              "url('https://lh3.googleusercontent.com/aida-public/AB6AXuBeDP-GcinWxS3joZLpm7jqXyHCNYZ_Go2ghL2gRvWl2NQ0xMJBwdigq5xhRMOadgGbNVLIpUXTQcSTXOPO5uXg2AGacRYWvJnxwoXjx71asx0upmwp3VvZJ1-rOe7D2ikhJMAgKGoaSXzS8UWAtbl8e2QC3hzxSOnUQJhyRHFGGo85BG3rQy9Xyypjrraf1pme6FymolmLE7gDwgKdPKCVdGmdsIy1hm9Md7KJzALiFZRRKDIMJNSMNYKN0QSF8nWLF_q_rPyKokLp')",
          }}
        ></div>
      </div>
    </header>
